    ...
    <>
        <div className='w-full flex justify-between items-center font-semibold'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <p className='bg-purple-500 w-7 h-7 text-black rounded-full flex items-center justify-center space-around'>D</p>
            </div>
        </div>
        <div className='flex items-center gap-2 mt-4'>
            <p className='bg-white text-black px-4 py-1 rounded-2xl'>All</p>
            <p className='bg-black px-4 py-1 rounded-2xl'>Music</p>
            <p className='bg-black px-4 py-1 rounded-3xl'>Podcasts</p>  
        </div>
    </>
  )
}
